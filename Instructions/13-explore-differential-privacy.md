...
用于训练机器学习模型的数据通常包含一些敏感值，我们应该让这些值保持私密。差别隐私是一种将“干扰”添加到数据中的技术，它让统计度量值和聚合信息与原始源数据保持一致，但更难识别单次观察的值。
...
## 使用 SmartNoise 探索差别隐私

本练习在笔记本中提供了用于使用 SmartNoise 探索差别隐私的代码。

1. 在 Jupyter 主页中，浏览到克隆的笔记本存储库所在的 **/users/*your-user-name*/mslearn-dp100** 文件夹，然后打开 **“探索差别隐私”** 笔记本。
