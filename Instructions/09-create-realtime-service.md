...
如果你不打算使机器学习模型可供应用程序使用，则训练和注册机器学习模型毫无意义。在本练习中，你要将模型部署为用于实时推理的 Web 服务。
...
本练习在笔记本中提供了用于将模型部署为实时推理服务的代码。

1. 在 Jupyter 主页中，浏览到克隆的笔记本存储库所在的 **/users/*your-user-name*/mslearn-dp100** 文件夹，然后打开 **“创建实时推理服务”** 笔记本。
